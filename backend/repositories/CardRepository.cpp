...
void CardRepository::doDeposit(const std::string&, dec::decimal<2>) {
    return;
}

void CardRepository::doWithdraw(const std::string&, dec::decimal<2>) {
    return;
}

void CardRepository::doTransfer(const std::string&, dec::decimal<2>) {
    return;
}
